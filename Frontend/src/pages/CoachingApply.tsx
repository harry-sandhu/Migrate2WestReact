...
export default function CoachingApply() {
  ...
  /* ---------- SAFETY ---------- */
  if (!slug) return <Navigate to="/coaching" replace />;

  const config =
    coachingConfig[
      slug as keyof typeof coachingConfig
    ];

  if (!config) return <Navigate to="/coaching" replace />;
  ...
  function isSlotAllowed(slot: Date) {
    ...
    const isOfficeTime = hour >= 10 && hour < 20;
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4 space-y-12">
          ...
          <ApplicationForm
            ...
            subtitle="Enter your details to enroll in coaching"
            value={applicant}
